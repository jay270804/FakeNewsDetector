...
// Mock WTCGL object (replace with actual implementation or import)
const WTCGL = window.WTCGL;
    ...
    const loadTextures = (textures) => {
      return new Promise((resolve) => {
        const loadTexture = (pointer) => {
          ...
          loadImage(imageObject).then((result) => {
  ...
  useEffect(() => {
    const loadWTCGL = () => {
      return new Promise((resolve, reject) => {
        ...
        script.src = "URL_TO_WTCGL_SCRIPT"; // Replace this with the actual URL of the WTCGL script
    ...
    loadWTCGL().then(() => {
      ...
      // Now WTCGL should be available
      const twodWebGL = new window.WTCGL(
        canvas,
        vertexShader,
        fragmentShader,
        window.innerWidth,
